    ...
    <section id="research" className="py-16 sm:py-20 px-6 sm:px-8 lg:px-12 bg-white/50">
      <div className="max-w-6xl mx-auto">
        ...
        <Tabs defaultValue="grants" className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 max-w-4xl mx-auto">
                      ...
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                        <div className="flex-1">
                          <div className="flex flex-wrap items-center gap-2 mb-2">
                            <Badge className="bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs">{pub.year}</Badge>
          ...
          <TabsContent value="proceedings">
            <motion.div {...fadeInUp}>
              <div className="space-y-4">
                {proceedingsData.map((proc, idx) => (
                  <Card key={idx} className={`border-l-4 ${idx % 2 === 0 ? 'border-l-purple-500' : 'border-l-pink-500'}`}>
                    <CardHeader>
                      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                        <div className="flex-1">
                          <div className="flex flex-wrap items-center gap-2 mb-2">
                            <Badge className="bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs">{proc.year}</Badge>
              ...
              <Card className="border-t-4 border-t-purple-500">
                <CardContent className="pt-6 space-y-3">
                  <div className="p-3 bg-purple-50 rounded-lg">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                      <div>
                        <p className="text-sm sm:text-base font-semibold">Machine Learning</p>
                        <p className="text-xs sm:text-sm text-gray-600">{language === 'id' ? 'Universitas Brawijaya Press' : 'Brawijaya University Press'}</p>
                      </div>
                      <Badge className="text-xs">2023</Badge>
                    </div>
                  </div>
                  <div className="p-3 bg-pink-50 rounded-lg">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                      <div>
                        <p className="text-sm sm:text-base font-semibold">{language === 'id' ? 'Sistem Basis Data' : 'Database Systems'}</p>
                        <p className="text-xs sm:text-sm text-gray-600">{language === 'id' ? 'Universitas Brawijaya Press' : 'Brawijaya University Press'}</p>
                      </div>
                      <Badge className="text-xs">2017</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
